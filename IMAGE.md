...
Choose the appropriate level of realism for the concept:

- literal photography
- constructed photography
- conceptual imagery
- graphic or manipulated imagery
...
Preserve believable physical detail.
...
Grain, motion blur, chromatic aberration, distortion, glow, and other effects may be used when appropriate.

They are optional tools, not permanent stylistic signatures.

Do not add effects simply to make an image appear more sophisticated.
...
Avoid generic visual presets or "cinematic" formulas.
